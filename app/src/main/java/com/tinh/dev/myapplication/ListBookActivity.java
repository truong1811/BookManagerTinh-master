        ...
        if (item.getItemId() == R.id.action_add_type_book) {
            ...
            btnAddTypeBook.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (result < 0) {
                        Toast.makeText(ListBookActivity.this, "Ma Loai Sach Da Ton Tai", Toast.LENGTH_SHORT).show();
                    } else {
                        typeBooks.add(0, typeBook);

                        adapterTypeBook.notifyDataSetChanged();

                        Toast.makeText(ListBookActivity.this, "Them loai sach thanh cong!!!", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                }
            });
